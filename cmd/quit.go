...
var quitCmd = &cobra.Command{
	Use:   "quit",
	Short: "Stops execution after receiving quit",
	Long: `Function will print messages till the quit channel receives a value`,
	Run: func(cmd *cobra.Command, args []string) {
		...
		quit := make(chan bool)
		c := functions.BoringOnQuit(msg, quit)
...
func init() {
	...
	quitCmd.Flags().String("msg", "Joe", "Message to print")
}
